...
class FrameWeatherSystem(BaseSystem):
    prefs = [
    ...
    def __init__(self):
        # 対話セッションを管理するための辞書
        self.sessiondic = {}
        # 対話行為とコンセプトを抽出するためのモジュール
        self.da_concept = DAConsept()
    ...
    def update_frame(self, frame, da, conceptdic):
        """与えられたdialog actにしたがってframeを更新"""

        # 値の整合性を確認して、整合のないものは空にする
    ...
    def initial_message(self, input):
        ...
        return {"utt": f"こちらは天気情報案内システムです。ご用件をどうぞ", "end": False}
    ...
    def reply(self, input):
        ...
        print(f"da={da} conceptdic={conceptdic}")

        # 対話行為タイプとコンセプト列を用いてフレームを更新
        ...
        if sys_da == "tell-info":
            ...
            lat = self.latlondic[place][0]
            lon = self.latlondic[place][1]
